...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--cluster_algo', help='Clustering algorithm', type=str, required=False, default='leiden', choices={'leiden', 'spectral'})
    ...
    parser.add_argument('--n_clusters', help='Number of clusters for spectral clustering. Ignored for leiden', type=int, required=False, default=None)
