...
if __name__ == '__main__':
    ...
    parser.add_argument('--downsample_rate', help='Rate by which the binary image of cells is downsampled before calculating the entropy and scatteredness metrics. \
                        If not provided, it is set to 1/2 of the smallest window size.', type=int, required=False, default=None)
