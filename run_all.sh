...
python main.py -f /goofys/Samples/slide_seq/mouse_testis/wt/WT3_ct.h5ad,/goofys/Samples/slide_seq/mouse_testis/diabetes/Diabetes2_ct.h5ad -o /home/ubuntu/results/testis/ -a annotation --win_sizes 150 --sliding_steps 50 --resolution 0.25 --min_num_celltype 1 --min_perc_celltype 10 --color_plot_system rgb --downsample_rate 40 --entropy_thres 1.0 --scatter_thres 1.0 --min_cells_coeff 1.5 --plotting 3 &
